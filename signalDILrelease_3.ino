/*                                                signalDIL release3
  Version 1 mod 3 nov 2021
            ...
            mod9 adds 2 aspect, 3 aspect switching for SP10
            mod10 2way bluetooth development 3 Feb 2022
...
void loop()
{
  ...
  if ((linkinstate  == LOW) && (aspectflag == LOW))   {
...

{
  ...
  if ( btt > (bttold + 4000))
  {
    ...
    if (dilacc1 == 0 )BTserial.print("SP10 2A - Sec AB length ");
    ...
    if (dilacc1 == 4 )BTserial.print("SP10 3A- Sec AB length ");
    if (dilacc1 == 5 )BTserial.print("U2");
    if (dilacc1 == 6 )BTserial.print("U3");
    if (dilacc1 == 7 )BTserial.print("U4");
